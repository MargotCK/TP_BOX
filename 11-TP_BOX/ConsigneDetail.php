...
-> Dans la classe "Fight", créez une méthode "fighting" qui doit prendre deux paramètres. Le premier paramètre représente l'objet que vous avez instancié de la classe Ippo, 
